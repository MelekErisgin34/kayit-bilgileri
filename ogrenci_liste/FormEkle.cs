...
namespace ogrenci_liste
{
    public partial class FormEkle : Form
    {
        ...
        string baglanti = "Server=localhost;Database=ogrenciler birligi;Uid=root;Pwd=''";
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(baglanti))
            {
                ...
                string sql = "INSERT INTO ogrenciler_liste (numara,ad,soyad,dtarih,cinsiyet,mezun_durum) " +
